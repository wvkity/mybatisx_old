...
public abstract class AbstractImmediateFuzzyExpression extends AbstractImmediateExpression {
    ...
    public AbstractImmediateFuzzyExpression mode(LikeMode mode) {
        this.mode = mode;
        return this;
    }

    public AbstractImmediateFuzzyExpression escape(Character escape) {
        this.escape = escape;
        return this;
    }
}
