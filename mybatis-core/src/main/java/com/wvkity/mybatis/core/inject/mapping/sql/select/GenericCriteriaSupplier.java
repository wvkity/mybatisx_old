 ...
 * @since 1.0.0
 */
public class GenericCriteriaSupplier extends AbstractCriteriaSupplier {

    public GenericCriteriaSupplier(Table table, MyBatisGlobalConfiguration configuration) {
