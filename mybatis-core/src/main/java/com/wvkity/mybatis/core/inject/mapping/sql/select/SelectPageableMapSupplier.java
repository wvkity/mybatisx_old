...
/**
 * {@code selectPageableMap}方法SQL供应器
 * @author wvkity
 * @created 2021-02-07
 * @since 1.0.0
 */
public class SelectPageableMapSupplier extends GenericCriteriaSupplier {

    public SelectPageableMapSupplier(Table table, MyBatisGlobalConfiguration configuration) {
