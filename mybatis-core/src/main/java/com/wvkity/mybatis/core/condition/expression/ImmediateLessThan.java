 ...
 * @since 1.0.0
 */
public class ImmediateLessThan extends BasicImmediateExpression {
    ...
    public static final class Builder extends AbstractImmediateExprBuilder<ImmediateLessThan> {
