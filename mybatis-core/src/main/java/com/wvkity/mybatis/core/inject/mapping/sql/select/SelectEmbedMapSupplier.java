...
/**
 * {@code selectEmbedMap}方法SQL供应器
 * @author wvkity
 * @created 2021-02-07
 * @since 1.0.0
 */
public class SelectEmbedMapSupplier extends GenericCriteriaSupplier {

    public SelectEmbedMapSupplier(Table table, MyBatisGlobalConfiguration configuration) {
