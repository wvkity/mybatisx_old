 ...
 * @since 1.0.0
 */
public class ImmediateGreaterThanOrEqual extends BasicImmediateExpression {
    ...
    public static final class Builder extends AbstractImmediateExprBuilder<ImmediateGreaterThanOrEqual> {
