...
/**
 * {@code selectMap}方法SQL供应器
 * @author wvkity
 * @created 2021-02-07
 * @since 1.0.0
 */
public class SelectMapSupplier extends GenericCriteriaSupplier {

    public SelectMapSupplier(Table table, MyBatisGlobalConfiguration configuration) {
