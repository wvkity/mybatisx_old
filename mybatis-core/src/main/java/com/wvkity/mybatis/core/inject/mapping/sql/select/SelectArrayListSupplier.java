...
/**
 * {@code selectArrayList}方法SQL供应器
 * @author wvkity
 * @created 2021-02-06
 * @since 1.0.0
 */
public class SelectArrayListSupplier extends GenericCriteriaSupplier {

    public SelectArrayListSupplier(Table table, MyBatisGlobalConfiguration configuration) {
