...
import com.wvkity.mybatis.core.inject.mapping.sql.select.SelectCountSupplier;
 ...
 * @since 1.0.0
 */
public class SelectCountInvoker extends AbstractSelectMethod<SelectCountSupplier> {
