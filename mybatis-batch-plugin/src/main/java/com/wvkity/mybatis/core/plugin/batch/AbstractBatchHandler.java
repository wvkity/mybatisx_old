...
import com.wvkity.mybatis.core.plugin.handler.AbstractHandler;
...
public abstract class AbstractBatchHandler extends AbstractHandler {
    ...
    public static final String PROP_KEY_BATCH_FILTER_METHODS = "filterMethods";
    ...
    protected Set<String> BATCH_FILTER_METHODS;
    ...
    public boolean filter(final MappedStatement ms, final Object parameter) {
        ...
        return sct == SqlCommandType.INSERT && BATCH_FILTER_METHODS.contains(this.execMethod(ms));
    }
    ...
    public void setProperties(Properties properties) {
        ...
        final String methodStr = properties.getProperty(PROP_KEY_BATCH_FILTER_METHODS);
        ...
        this.BATCH_FILTER_METHODS = Collections.unmodifiableSet(methods);
    }
