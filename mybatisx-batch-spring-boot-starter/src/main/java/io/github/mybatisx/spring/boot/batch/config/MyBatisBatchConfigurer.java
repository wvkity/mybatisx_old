 ...
 * the License.
 */
package io.github.mybatisx.spring.boot.batch.config;

import io.github.mybatisx.plugin.batch.AbstractBatchHandler;
import io.github.mybatisx.spring.boot.batch.MyBatisBatchAutoConfiguration;
