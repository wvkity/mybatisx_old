...
public interface AuditedEventListener<T> extends EventListener<AuditedEvent<T>> {
    ...
    @TransactionalEventListener(phase = TransactionPhase.BEFORE_COMMIT,
        condition = "T(com.github.mybatisx.auditable.event.EventPhase).BEFORE_COMMIT eq #event.eventPhase")
    ...
    @TransactionalEventListener(phase = TransactionPhase.AFTER_COMMIT,
        condition = "T(com.github.mybatisx.auditable.event.EventPhase).AFTER_COMMIT eq #event.eventPhase")
    ...
    @TransactionalEventListener(phase = TransactionPhase.AFTER_ROLLBACK,
        condition = "T(com.github.mybatisx.auditable.event.EventPhase).AFTER_ROLLBACK eq #event.eventPhase")
    ...
    @TransactionalEventListener(phase = TransactionPhase.AFTER_COMPLETION,
        condition = "T(com.github.mybatisx.auditable.event.EventPhase).AFTER_COMPLETION eq #event.eventPhase")
