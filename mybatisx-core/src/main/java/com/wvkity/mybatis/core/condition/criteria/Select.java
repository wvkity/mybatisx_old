...
public interface Select<T, Chain extends Select<T, Chain>> {
     ...
     * @return {@link Chain}
     */
    Chain ignore(final Property<T, ?> property);
     ...
     * @return {@link Chain}
     */
    Chain ignore(final String property);
     ...
     * @return {@link Chain}
     */
    Chain colIgnore(final String column);
     ...
     */
    @SuppressWarnings("unchecked")
    Chain ignores(final Property<T, ?>... properties);
     ...
     * @return {@link Chain}
     */
    default Chain ignores(final String... properties) {
        return ignores(Objects.asList(properties));
    }
     ...
     * @return {@link Chain}
     */
    Chain ignores(final Collection<String> properties);
     ...
     * @return {@link Chain}
     */
    default Chain colIgnores(final String... columns) {
        return colIgnores(Objects.asList(columns));
    }
     ...
     * @return {@link Chain}
     */
    Chain colIgnores(final Collection<String> columns);
