...
/**
 * {@code selectMapWithEmbed}方法SQL供应器
 * @author wvkity
 * @created 2021-02-07
 * @since 1.0.0
 */
public class SelectMapWithEmbedSupplier extends GenericCriteriaSupplier {

    public SelectMapWithEmbedSupplier(Table table, MyBatisGlobalConfiguration configuration) {
