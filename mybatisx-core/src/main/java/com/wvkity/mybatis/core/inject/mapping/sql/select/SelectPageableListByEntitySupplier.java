...
/**
 * {@code selectPageableListByEntity}方法SQL提供器
 * @author wvkity
 * @created 2020-12-25
 * @since 1.0.0
 */
public class SelectPageableListByEntitySupplier extends AbstractSupplier {

    public SelectPageableListByEntitySupplier(Table table, MyBatisGlobalConfiguration configuration) {
