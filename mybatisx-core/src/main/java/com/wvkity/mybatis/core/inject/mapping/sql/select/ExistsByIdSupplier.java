 ...
 * @since 1.0.0
 */
public class ExistsByIdSupplier extends AbstractSupplier {

    public ExistsByIdSupplier(Table table, MyBatisGlobalConfiguration configuration) {
    ...
    public String get() {
        return this.select("CASE WHEN COUNT(*) > 0 THEN 1 ELSE 0 END RECORDS",
            "WHERE " + Scripts.convertToPartArg(PARAM_ID, Operation.NONE, this.table.getIdColumn()));
    }
}
