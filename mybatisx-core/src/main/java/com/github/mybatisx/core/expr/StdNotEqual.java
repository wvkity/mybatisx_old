 ...
 * @since 1.0.0
 */
public class StdNotEqual extends AbstractBasicExpression<Column> {

    private static final long serialVersionUID = -8879802952196072736L;

    public StdNotEqual(Criteria<?> criteria, Column column, Slot slot, Object value) {
    ...
    public static StdNotEqual.Builder create() {
    ...
    public static final class Builder extends AbstractBasicExprBuilder<StdNotEqual, Column> {
        ...
        @Override
        public StdNotEqual build() {
            if (Objects.nonNull(this.target)) {
                return new StdNotEqual(this.criteria, this.target, this.slot, this.value);
            }
            return null;
        }
    }
