 ...
 * @since 1.0.0
 */
public class ImdEqual extends AbstractBasicExpression<String> {

    private static final long serialVersionUID = -6607630163120844012L;

    public ImdEqual(Criteria<?> criteria, String column, Slot slot, Object value) {
    ...
    public static ImdEqual.Builder create() {
        return new ImdEqual.Builder();
    }

    public static final class Builder extends AbstractBasicExprBuilder<ImdEqual, String, Builder> {
