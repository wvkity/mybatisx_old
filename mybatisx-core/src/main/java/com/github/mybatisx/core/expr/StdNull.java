 ...
 * @since 1.0.0
 */
public class StdNull extends AbstractNullableExpression<Column> {

    private static final long serialVersionUID = 3125090725718103619L;

    public StdNull(Criteria<?> criteria, Column column, Slot slot) {
    ...
    public static StdNull.Builder create() {
    ...
    public static final class Builder extends AbstractExprBuilder<StdNull, Column, Builder> {
        ...
        @Override
        public StdNull build() {
            if (Objects.nonNull(this.target)) {
                return new StdNull(this.criteria, this.target, this.slot);
            }
            return null;
        }
    }
