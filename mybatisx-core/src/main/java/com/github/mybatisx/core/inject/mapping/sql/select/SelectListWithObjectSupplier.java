...
/**
 * {@code selectListWithObject}方法SQL提供器
 * @author wvkity
 * @created 2021-02-05
 * @since 1.0.0
 */
public class SelectListWithObjectSupplier extends GenericCriteriaSupplier {

    public SelectListWithObjectSupplier(Table table, MyBatisGlobalConfiguration configuration) {
