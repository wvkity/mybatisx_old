 ...
 * @since 1.0.0
 */
public interface StandardFragmentManager<C extends Criteria<?>> extends FragmentManager<C> {

    /**
     * 添加{@link Selection}
     * @param selection {@link Selection}
     * @return {@link StandardFragmentManager}
     */
    StandardFragmentManager<C> select(final Selection selection);
     ...
     * @return {@link StandardFragmentManager}
     */
    StandardFragmentManager<C> select(final Collection<Selection> selections);
     ...
     * @return {@link StandardFragmentManager}
     */
    StandardFragmentManager<C> exclude(final String property);
     ...
     * @return {@link StandardFragmentManager}
     */
    StandardFragmentManager<C> colExclude(final String column);
     ...
     * @return {@link StandardFragmentManager}
     */
    StandardFragmentManager<C> groupBy(final Group group);
     ...
     * @return {@link StandardFragmentManager}
     */
    StandardFragmentManager<C> groupBy(final Collection<Group> groups);
     ...
     * @return {@link StandardFragmentManager}
     */
    StandardFragmentManager<C> having(final Having having);
     ...
     * @return {@link StandardFragmentManager}
     */
    StandardFragmentManager<C> having(final Collection<Having> havingList);
     ...
     * @return {@link StandardFragmentManager}
     */
    StandardFragmentManager<C> orderBy(final Order order);
