...
public class AnnotationAwareInterceptorOrderComparator extends InterceptorOrderComparator {
    ...
    private static Integer findOrder(MergedAnnotations annotations) {
        ...
        MergedAnnotation<com.wvkity.mybatis.core.plugin.annotation.Order> pluginOrderAnnotation =
            annotations.get(com.wvkity.mybatis.core.plugin.annotation.Order.class);
