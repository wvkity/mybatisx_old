...
import com.wvkity.mybatis.core.invoker.FieldGetterInvoker;
import com.wvkity.mybatis.core.invoker.FieldSetterInvoker;
import com.wvkity.mybatis.core.invoker.Invoker;
...
public class Column {
    ...
    public Column(Class<?> entity, String property, String column,
                  ...
                  boolean checkNotEmpty, boolean version, boolean tenement, boolean logicalDeletion,
    ...
    public boolean equals(Object o) {
        ...
        return unique == column1.unique &&
            ...
            tenement == column1.tenement &&
            logicalDeletion == column1.logicalDeletion &&
    ...
    public int hashCode() {
        return Objects.hash(entity, property, column, jdbcType, javaType, typeHandler, sequence, unique,
            ...
            version, tenement, logicalDeletion, descriptor, primaryKey, auditor);
    }
