 ...
 * the License.
 */
package io.github.mybatisx.basic.builder;

import io.github.mybatisx.Objects;
import io.github.mybatisx.Strings;
import io.github.mybatisx.annotation.Executing;
import io.github.mybatisx.basic.invoker.Invoker;
...
import io.github.mybatisx.keyword.ReservedWordRegistry;
...
public class ColumnBuilder extends AbstractBuilder implements Builder<Column> {
     ...
     * 审计策略列表
     */
    private Set<Integer> auditPolicies;
    /**
    ...
    public Column build() {
        ...
        return new Column(this.entity, this.property, handleColumnName(), this.jdbcType, this.typeHandler,
            ...
            this.logicDelete, descriptor, primaryKey, auditMeta);
    }
    ...
    public ColumnBuilder auditType(int auditType) {
        this.auditType = auditType;
        return this;
    }

    public Set<Integer> auditPolicies() {
        return auditPolicies;
    }

    public ColumnBuilder auditPolicies(Set<Integer> auditPolicies) {
