 ...
 * the License.
 */
package com.github.mybatisx.basic.keyword;
 ...
 * @since 1.0.0
 */
public final class ReservedWordRegistry {
     ...
     * 关键词缓存
     */
    private static final Set<String> RESERVED_WORD_CACHE;
    ...
    static {
        ...
        RESERVED_WORD_CACHE = new HashSet<>(words.length + 10);
        RESERVED_WORD_CACHE.addAll(Arrays.asList(words));
    }

    /**
     * 注册新的关键子
     * @param keyWord 待注册关键字
     * @return boolean
     */
    public static boolean registry(final String keyWord) {
        if (Objects.isNotBlank(keyWord)) {
            return RESERVED_WORD_CACHE.add(Strings.toUpper(keyWord.trim()));
        }
        return false;
    }
    ...
    public static boolean contains(String word) {
        return Objects.isNotBlank(word) && RESERVED_WORD_CACHE.contains(Strings.toUpper(word));
    }
}
