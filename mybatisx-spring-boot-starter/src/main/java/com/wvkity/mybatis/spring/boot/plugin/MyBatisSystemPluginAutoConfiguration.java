...
import com.wvkity.mybatis.core.plugin.auditable.SystemAuditingHandler;
import com.wvkity.mybatis.core.plugin.auditable.SystemAuditingInterceptor;
...
import com.wvkity.mybatis.spring.boot.autoconfigure.MyBatisAutoConfiguration;
...
@AutoConfigureAfter(value = {MyBatisAutoConfiguration.class},
    name = {"com.wvkity.mybatis.spring.boot.auditable.MyBatisMetadataAuditingAutoConfiguration"})
