 ...
 * the License.
 */
package com.github.mybatisx.spring.comparator;
...
public class AnnotationAwareInterceptorOrderComparator extends InterceptorOrderComparator {
    ...
    private static Integer findOrder(MergedAnnotations annotations) {
        ...
        MergedAnnotation<com.github.mybatisx.plugin.annotation.Order> pluginOrderAnnotation =
            annotations.get(com.github.mybatisx.plugin.annotation.Order.class);
